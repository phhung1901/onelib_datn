...
class SamePart
{
    ...
    public static function sameStartWords(...$strings): string
    {
        foreach ($strings as $k => $string) {
            $strings[$k] = preg_split("/\s/ui", $string) ?: [];
        }
    ...
    public static function sameEndWords(...$strings): string
    {
        foreach ($strings as $k => $string) {
            $strings[$k] = array_reverse(preg_split("/\s/ui", $string) ?: []);
        }
